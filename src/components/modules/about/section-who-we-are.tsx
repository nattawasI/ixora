...
const SlideWhoWeAre = () => {
  ...
  return (
    <div className="relative py-[7.5rem]">
      <div className="c-container">
        <div className="space-y-7">
          ...
          <p>
            ...
            spanning Thailand, Asia, Australia, and the United States. Driven by a passion to elevate the profession,
            our dynamic team is committed to delivering innovative and{' '}
          ...
          <p className={cn('hidden', isShowMore ? 'block' : 'hidden')}>
            ...
            cultivated <span className="font-bold">a deep expertise in sustainable design</span>. Through experimental
            projects, design competitions, and collaborations with educational, public, and private sectors, we
            translate ecological design theories into practical, sustainable and impactful solutions. We are dedicated
            to environmental preservation and restoring balance to natural ecosystems. Ixora Design partners with
            clients to create exceptional landscapes that seamlessly integrate function, technology, and aesthetic
            design with the natural environment. We are committed to fostering a sustainable future for people, animals,
            and the planet.
          </p>
