...
const ButtonCopy = ({
  ...
  return (
    <button
      ...
      className={cn(
        'typo-body-3 border-blue inline-flex h-[1.625rem] items-center gap-x-[0.188rem] rounded-full border px-[0.625rem] font-bold uppercase transition-colors duration-300',
